...
const Projects = () => {
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>PROJECTS | Temple Ajuzie </title>
        <link rel="canonical" href="https://www.templeajuzie.com/projects" />
        <meta
          name="keywords"
...
, Search Engine Optimisation, Website Design, Search Engine Optimisation, Logo Design, Copywriting, Hosting"
        ...
        <meta
          name="desccription"
          content="Here are some of the amazing projects that Temple Ajuzie has built."
        />
      </Helmet>
      <Navbar />
      <Body>
